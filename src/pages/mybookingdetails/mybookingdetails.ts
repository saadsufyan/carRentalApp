...
/**
 * Generated class for the MybookingdetailsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mybookingdetails',
  templateUrl: 'mybookingdetails.html',
})
export class MybookingdetailsPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MybookingdetailsPage');
  }
  ionViewWillEnter(){ 
